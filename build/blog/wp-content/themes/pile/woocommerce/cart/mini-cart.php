...
<?php if ( ! wpgrade::option('nav_show_always') ) { ?>
	<a href="<?php echo $woocommerce->cart->get_cart_url(); ?>" class="cart-widget-label"><?php _e( 'Cart', wpgrade::textdomain() ); ?></a>
<?php } else { ?>
...
<div class="cart-widget-details">
	<?php if ($woocommerce->cart->cart_contents_count): ?>
		<p class="cart-widget-summary">
			<?php echo __( 'You have ', wpgrade::textdomain() ) . '<cart class="shop-items-number">' . sprintf( _n( '1 item in cart.', '%1$s items in cart.', $woocommerce->cart->cart_contents_count, wpgrade::textdomain() ), number_format_i18n( $woocommerce->cart->cart_contents_count ) ) .'</cart>'; ?>
		</p>
	<?php else: ?>
