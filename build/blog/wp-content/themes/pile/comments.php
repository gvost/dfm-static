	...
	<div id="comments" class="comments-area  <?php if ( ! have_comments() ) { echo 'no-comments'; } ?>">
		<div class="comments-area-title">
			<h3 class="comments-title">
				<?php
				if ( have_comments() ):
					printf( _n( '<span class="comment-number  comment-number--dark  total">1</span> comment', '<span class="comment-number  comment-number--dark  total">%1$s</span> Comments', get_comments_number(), wpgrade::textdomain() ), number_format_i18n( get_comments_number() ) );
				else:
					_e( '<span class="comment-number  comment-number--dark">+</span> There are no comments', wpgrade::textdomain() );
				endif;
				?>
			</h3>
...
if ( ! comments_open() && post_type_supports( get_post_type(), 'comments' ) && ! is_page() ) :
	?>
	<p class="nocomments"><span class="comment-number comment-number--dark  no-comments-box"><i class="icon icon-times"></i></span><span><?php _e( 'Comments are closed.', wpgrade::textdomain() ); ?></span></p>
<?php endif;
...
if ( is_user_logged_in() ) {
	...
	$comments_args = array(
		...
		'title_reply'          => __( 'Leave a Comment', wpgrade::textdomain() ),
